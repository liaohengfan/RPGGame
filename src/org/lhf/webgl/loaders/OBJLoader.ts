...
class OBJLoader {
    ...
    parse(text: any) {
        ...
        let lines:any = text.split('\n');
        let line:any = '';
        let lineFirstChar:any = '';
        let lineLength:any = 0;
        let result:any = [];

        // Faster to just trim left side of the line. Use if available.
        let trimleftStr:any='';
        let trimleftFun:any=typeof trimleftStr.trimLeft;
        let trimLeft = ( typeof trimleftFun === 'function' );
        ...
        for (let i = 0, l = lines.length; i < l; i++) {
            ...
            if (lineFirstChar === 'v') {
                ...
                let lineParts:any = line.substring(1).trim().split(" ");
        ...
        let container:any = new THREE.Group();
...
class ParserState {
    ...
    normals: Array<any> = [];
    uvs: Array<any> = [];
    materialLibraries:Array<any>=[];

    constructor() {
        this.startObject( '', false );
    }
    startObject( name:any, fromDeclaration:any ) {
        ...
        this.object = {
            ...
            startMaterial: function ( name:any, libraries:any ) {
    ...
    parseVertexIndex( value:any, len:any ) {

        let index = parseInt( value, 10 );
        return ( index >= 0 ? index - 1 : index + len / 3 ) * 3;

    }
    parseNormalIndex( value:any, len:any ) {

        let index = parseInt( value, 10 );
        return ( index >= 0 ? index - 1 : index + len / 3 ) * 3;

    }
    parseUVIndex( value:any, len:any ) {
    ...
    addFace( a:any, b:any, c:any, ua:any, ub:any, uc:any, na:any, nb:any, nc:any ) {
